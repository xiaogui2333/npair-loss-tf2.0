...
import sys
from tensorpack.callbacks.base import Callback, CallbackFactory
from tensorpack.callbacks.graph import RunOp
from tensorpack.dataflow import DataFlow, MapData, RepeatedData
from tensorpack.tfutils.common import get_op_tensor_name
from tensorpack.tfutils.dependency import dependency_of_fetches
from tensorpack.tfutils.summary import add_moving_summary
from tensorpack.tfutils.tower import get_current_tower_context
from tensorpack.utils import logger
from tensorpack.utils.concurrency import ShareSessionThread
from tensorpack.input_source.input_source_base import InputSource
...
class TFDatasetInput(FeedfreeInput):
    ...
    @staticmethod
    def dataflow_to_dataset(df, types, shapes):
        """
        ...
        ds = tf.data.Dataset.from_generator(
            df.get_data, tuple(types), tuple(shapes))
        return ds
