...
if __name__=='__main__':
	...
	parser.add_argument("--source", default="C:\\Users\\xukaiping\\Desktop\\train.txt") # codes/bnneck_npair_256_mega_80_lr_dropout_nor
	parser.add_argument("--model_path", default='./model/no-dropout')
	...
	parser.add_argument("--max_iters", default=200000)
	...
	NpairData = NpairDataClass(args)
	NpairData.setUp()
	while True:
		files_labels = NpairData.next_iteration_v2()
		for i in files_labels:
			print(i[0],i[1],i[2])
