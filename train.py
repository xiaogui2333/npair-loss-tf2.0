...
# tensorpack train dataflow
# def get_train_input(data_dir, args):
#     ds = get_train_dataflow(data_dir, args)
#     ds = TFDatasetInput.dataflow_to_dataset(ds, (tf.float32, tf.int32),
#                                                 ([None, None, None, 3],
#                                                  [None]))
#     train_input_dataset = ds.batch(args.batch, drop_remainder=True).prefetch(
#             tf.data.experimental.AUTOTUNE)
#     return train_input_dataset
